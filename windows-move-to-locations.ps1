...
$__configs = @(
  [pscustomobject]@{FileName='windows\.gitconfig'; Dest=$HOME}
  [pscustomobject]@{FileName='windows\.gitignore_global'; Dest=$HOME}
  [pscustomobject]@{FileName='windows\.npmrc'; Dest=$HOME}
  [pscustomobject]@{FileName='windows\PowerShell_profile.ps1'; Dest=$PROFILE}
)
